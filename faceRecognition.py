...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('F://face//haarcascade_frontalface_default.xml')  #Load haar classifier
...
def draw_rect(test_img,face,col):
    (x,y,w,h)=face
    if col == 0:
...
def put_text(test_img,text,x,y):
    cv2.putText(test_img,text,(x,y),cv2.FONT_HERSHEY_DUPLEX,2,(300,0,0),4)
